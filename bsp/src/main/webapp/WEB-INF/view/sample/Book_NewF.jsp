...
<body>
    ...
    <div class="wrap">
        ...
        <div class="mem_content">
            <h1 class="bestmain_top">외국도서 종합신간</h1>
            ...
            <div class="SmallIndex_book">
                <div class="s_imgSection">
                    <div class="best_rank" style="font-size: 19px;">6.</div>
                    <div class="s_bookImg"><img src = "img/newStar4.jpg" style="height: 250px; width: 180px; margin:-20px"></div>
                </div>
                <div class="s_infoSectionWrap">
                    <div class="s_infoSection">
            ...
            <div class="SmallIndex_book">
                <div class="s_imgSection">
                    <div class="best_rank" style="font-size: 19px;">7.</div>
                    <div class="s_bookImg"><img src = "img/newStar4.jpg" style="height: 250px; width: 180px; margin:-20px"></div>
                </div>
                <div class="s_infoSectionWrap">
                    <div class="s_infoSection">
            ...
            <div class="SmallIndex_book">
                <div class="s_imgSection">
                    <div class="best_rank" style="font-size: 19px;">8.</div>
                    <div class="s_bookImg"><img src = "img/newStar4.jpg" style="height: 250px; width: 180px; margin:-20px"></div>
                </div>
                <div class="s_infoSectionWrap">
                    <div class="s_infoSection">
            ...
            <div class="SmallIndex_book">
                <div class="s_imgSection">
                    <div class="best_rank" style="font-size: 19px;">9.</div>
                    <div class="s_bookImg"><img src = "img/newStar4.jpg" style="height: 250px; width: 180px; margin:-20px"></div>
                </div>
                <div class="s_infoSectionWrap">
                    <div class="s_infoSection">
            ...
            <div class="SmallIndex_book">
                <div class="s_imgSection">
                    <div class="best_rank" style="font-size: 19px;">10.</div>
                    <div class="s_bookImg"><img src = "img/newStar4.jpg" style="height: 250px; width: 180px; margin:-20px"></div>
                </div>
                <div class="s_infoSectionWrap">
                    <div class="s_infoSection">
